...
fn calc_moves(jumps: &mut Vec<i64>, stepper: fn(i64) -> i64) -> u64 {
    ...
    while index >= 0 && (index as usize) < jumps.len() {
        ...
        index += jumps[old_index];
        jumps[old_index] += stepper(jumps[old_index]);
    }
